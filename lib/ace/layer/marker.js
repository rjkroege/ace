...
(function() {
    ...
    // TODO(rjkroege): Write this.
    // Hide the layer.
    this.hideForNow  = function() {
        console.info('hideForNow\n');
        dom.addCssClass( this.element, 'visability: hidden;');
    };

    // TODO(rjkroege): Write this too.
    // Show the layer.
    this.showItNow = function() {
        dom.removeCssClass( this.element, 'visability: hidden;');
    };
